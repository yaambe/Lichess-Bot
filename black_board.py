...
def create_chess_board_dict(x1, y1, x2, y2):
    ...
    for row in range(8):
        for col in range(8):
            square_name = chr(104 - col) + str(row + 1)
...
black_chess_board_dict = create_chess_board_dict(x1, y1, x2, y2)

black_board_fen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"